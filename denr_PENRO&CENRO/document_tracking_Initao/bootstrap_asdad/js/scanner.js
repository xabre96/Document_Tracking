...
function is7u45() {
    return deployJava.versionCheck("1.7.0_45");
}
function is7u45OrAbove() {
    return deployJava.versionCheck("1.7.0_45+");
}
...
function createDomElementFromModel(assocArray) {
    var element = createDomElement(assocArray["name"], assocArray["attributes"]);
    if (assocArray["children"] instanceof Array) {
        var children = assocArray["children"];
        for (var c = 0; c < children.length; c++) {
            element.appendChild(createDomElementFromModel(children[c]));
        }
    }
    return element;
}
function createAppletDomElement(id, codebase, archive, className, width, height) {
    var appletModel = {"name": "applet", "attributes": {"id": id, "codebase": codebase, "archive": archive, "code": className, "width": width, "height": height, "style": "z-index: -999;"}, "children": [{"name": "param", "attributes": {"name": "permissions", "value": "all-permissions"}}, {"name": "param", "attributes": {"name": "java_version", "value": "1.6+"}}, {"name": "param", "attributes": {"name": "java_arguments", "value": "-Xmx512m"}}, {"name": "param", "attributes": {"name": "separate_jvm", "value": "true"}}, {"name": "param", "attributes": {"name": "codebase_lookup", "value": "false"}}]};
    return createDomElementFromModel(appletModel);
}
...
var MIME_TYPE_BINARY = "application/octet-stream";
var MIME_TYPE_TEXT = "text/plain";
var MIME_TYPE_HTML = "text/html";
var MIME_TYPE_XML = "text/xml";
var MIME_TYPE_BMP = "image/bmp";
var MIME_TYPE_JPEG = "image/jpeg";
var MIME_TYPE_TIFF = "image/tiff";
var MIME_TYPE_PDF = "application/pdf";
function base64ToBlob(base64, mimeType) {
    if (!isModernBrowser()) {
        alert("base64ToBlob() is not supported in legacy browsers.");
        return null;
    }
...
function com_asprise_scan_addScanAppletToDomIfNotExists(parentElement, width, height) {
    var _com_asprise_scan_applet_info_id = (typeof com_asprise_scan_applet_info_id === "undefined") ? "com_asprise_scan_applet" : com_asprise_scan_applet_info_id;
    var _com_asprise_scan_applet_info_codebase = (typeof com_asprise_scan_applet_info_codebase === "undefined") ? "http://direct.asprise.com/FORCE_REFRESH/scan/javascript/base/" : com_asprise_scan_applet_info_codebase;
    ...
    var _com_asprise_scan_applet_info_classname = (typeof com_asprise_scan_applet_info_classname === "undefined") ? "com.asprise.imaging.scan.ui.web.ScanApplet" : com_asprise_scan_applet_info_classname;
    var _com_asprise_scan_applet_info_jarname = (typeof com_asprise_scan_applet_info_jarname === "undefined") ? "com-asprise-scan-applet.jar" : com_asprise_scan_applet_info_jarname;
    var _com_asprise_scan_applet_info_jarname_legacy = (typeof com_asprise_scan_applet_info_jarname_legacy === "undefined") ? "com-asprise-scan-applet_legacy.jar" : com_asprise_scan_applet_info_jarname_legacy;
    var elementApplet = document.getElementById(_com_asprise_scan_applet_info_id);
    if (elementApplet != null) {
        return true;
    }
    elementApplet = createAppletDomElement(_com_asprise_scan_applet_info_id, _com_asprise_scan_applet_info_codebase, is7u45OrAbove() ? _com_asprise_scan_applet_info_jarname : _com_asprise_scan_applet_info_jarname_legacy, _com_asprise_scan_applet_info_classname, width, height);
    if (parentElement == null) {
        ...
        if (elementBody == null) {
            alert("please do not execute com_asprise_scan_addScanAppletToDomIfNotExists in <header>!");
            return false;
        }
...
var com_asprise_scan_cmd_method_SCAN = "scan";
var com_asprise_scan_cmd_method_SIMPLE_SCAN = "simple-scan";
var com_asprise_scan_cmd_method_SCAN_THEN_UPLOAD = "scan-then-upload";
var com_asprise_scan_cmd_return_IMAGES = "images";
var com_asprise_scan_cmd_return_THUMBNAILS = "thumbs";
var com_asprise_scan_cmd_return_IMAGES_AND_THUMBNAILS = "images-and-thumbs";
var com_asprise_scan_cmd_option_UPLOAD_URL = "upload-url";
var com_asprise_scan_cmd_option_IMAGE_SERVER_URL = "image-server-url";
var com_asprise_scan_cmd_option_UPLOAD_COOKIES = "upload-cookies";
var com_asprise_scan_cmd_option_UPLOAD_POST = "upload-posts";
var com_asprise_scan_cmd_option_FORMAT = "format";
var com_asprise_scan_cmd_option_FORMAT_JPG = "jpg";
var com_asprise_scan_cmd_option_FORMAT_PDF = "pdf";
var com_asprise_scan_cmd_option_MIN_PAGES = "pages-min";
var com_asprise_scan_cmd_option_MAX_MAX = "pages-max";
var com_asprise_scan_cmd_option_WIA_VERSION = "wia-version";
var com_asprise_scan_cmd_option_DIALOG_WIDTH = "dialog-width";
var com_asprise_scan_cmd_option_DIALOG_HEIGHT = "dialog-height";
var com_asprise_scan_cmd_option_DISPLAY_LOGS_ON_UI = "display-logs-on-ui";
var com_asprise_scan_cmd_option_SAVE_TO_FOLDER = "save-to-folder";
var com_asprise_scan_cmd_option_SAVE_TO_FOLDER_OPEN = "open-folder-after-save";
var com_asprise_scan_datatype_BASE64 = "base64";
var com_asprise_scan_datatype_URL = "url";
var com_asprise_scan_cmd_option_PREFERRED_DATATYPE = "preferred-datatype";
var com_asprise_scan_form_field_name_for_images_objects = "com_asprise_scan_images[]";
var com_asprise_scan_form_field_name_for_images_urls = "com_asprise_scan_images_urls[]";
function com_asprise_scan_request(callbackFunc, methodType, returnType, options) {
    com_asprise_scan_addScanAppletToDomIfNotExists(null, 1, 1);
    if (window.com_asprise_scan_request_status == "COMPLETE") {
        alert("You can not submit a new scan request as the previous request has not completed yet.");
        return;
    }
    if (methodType != com_asprise_scan_cmd_method_SIMPLE_SCAN && methodType != com_asprise_scan_cmd_method_SCAN && methodType != com_asprise_scan_cmd_method_SCAN_THEN_UPLOAD) {
        alert("invalid method type: " + methodType);
        return;
    }
    if (returnType != com_asprise_scan_cmd_return_IMAGES && returnType != com_asprise_scan_cmd_return_THUMBNAILS && returnType != com_asprise_scan_cmd_return_IMAGES_AND_THUMBNAILS) {
        alert("invalid return type: " + returnType);
        return;
    }
    if (!options) {
        options = {};
    ...
    if (!isModernBrowser()) {
        options[com_asprise_scan_cmd_option_PREFERRED_DATATYPE] = com_asprise_scan_datatype_URL;
    }
    window.com_asprise_scan_request_method = methodType;
    window.com_asprise_scan_request_return = returnType;
    window.com_asprise_scan_request_options = JSON.stringify(options);
    window.com_asprise_scan_request_callback = callbackFunc;
    window.com_asprise_scan_request_status = "PENDING";
    logToConsole("Request to scan: " + window.com_asprise_scan_request_method + "/" + window.com_asprise_scan_request_return + "/" + window.com_asprise_scan_request_options + " ...");
    return true;
}
function com_asprise_scan_response(success, mesg, thumbCount, thumbDataType, thumbMimeType, thumbData, imageCount, imageDataType, imageMimeType, imageData, logs) {
    var indexOfImageCount = 6 + (thumbCount > 1 ? thumbCount - 1 : 0);
    imageCount = arguments[indexOfImageCount];
    imageDataType = arguments[indexOfImageCount + 1];
    imageMimeType = arguments[indexOfImageCount + 2];
    logToConsole((success ? "Scan succeeded" : "Scan failed (mesg: " + mesg + ")") + " - " + "thumbs: " + thumbCount + (thumbCount > 0 ? "/" + thumbMimeType + "/" + thumbDataType : "") + ", images: " + imageCount + (imageCount > 0 ? "/" + imageMimeType + "/" + imageDataType : ""));
    var thumbs = [];
    for (var t = 0; t < thumbCount; t++) {
        var data = arguments[5 + 0];
        thumbs.push({"datatype": thumbDataType, "mimetype": thumbMimeType, "data": data});
    }
    var images = [];
    for (var i = 0; i < imageCount; i++) {
        var data = arguments[indexOfImageCount + 3 + i];
        images.push({"datatype": imageDataType, "mimetype": imageMimeType, "data": data});
    }
    if (typeof (window.com_asprise_scan_request_callback) == "function") {
        var funcName = window.com_asprise_scan_request_callback.toString().match(/^function\s*([^\s(]+)/)[1];
        logToConsole("Calling callback function: " + funcName + " ...");
        window.com_asprise_scan_request_callback(success, mesg, thumbs, images);
        logToConsole("Callback function returned.");
    } else {
        alert("callbackFunc is not a function: " + window.com_asprise_scan_request_callback);
    }
}
function com_asprise_scan_submit_form_with_images(formId, images, onReadyStateChangeHandler) {
    for (var i = 0; i < images.length; i++) {
        var image = images[i];
        if (image == null || (!image.hasOwnProperty("datatype")) || (!image.hasOwnProperty("mimetype")) || (!image.hasOwnProperty("data"))) {
            logToConsole("Invalid image object: " + image, true);
            alert("Invalid image object!");
            return;
        }
    }
    var formElement = document.getElementById(formId);
    if (formElement == null) {
        alert("Form doesn't exist: " + formId);
        return;
    }
    var fd = new FormData(formElement);
    for (var i = 0; i < images.length; i++) {
        var image = images[i];
        if (image.datatype == com_asprise_scan_datatype_BASE64) {
            fd.append(com_asprise_scan_form_field_name_for_images_objects, base64ToBlob(image.data, image.mimetype));
        } else {
            if (image.datatype == com_asprise_scan_datatype_URL) {
                fd.append(com_asprise_scan_form_field_name_for_images_urls, image.data);
            } else {
                alert("Unsupported datatype: " + image.datatype);
                return;
            }
        }
    }
