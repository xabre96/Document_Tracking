            ...
            <aside class="right-side" >
                ...
                <section class="content" >
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box">
                                <div class="box-header" style="background: #ffe600; color: #black;">
                                    <h3 class="box-title"><i class="glyphicon glyphicon-edit"></i><span>&nbsp;FOLLOW-UP DOCUMENTS</span></h3>                                    
                                </div><!-- /.box-header -->
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                ?>
                                <p><b>Action Man :</b> <br/><?php echo $oth; ?></p>
