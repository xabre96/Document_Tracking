...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Department of Environment and Natural Resources || View Due Date Documents</title>
...
<header class="header">
    ...
    <a href="index.html" class="logo" style="background: #154466;">
        ...
        <font face="'Source Sans Pro', sans-serif"><strong>Region 10</strong></font>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" role="navigation" style="background: #154466;">
        <!-- Sidebar toggle button-->
        <a href="#" class="navbar-btn sidebar-toggle" data-toggle="offcanvas" role="button">
            <i class="glyphicon glyphicon-fullscreen" style="color: yellow; font-size: 19px;"></i>
        </a>
