                                ...
                                <div class="main-content" style="background: #FFF;">
                                    <div class="main-content-inner">
                                        <!-- <form method="POST" action="<?php echo base_url('Users/userLogin'); ?>"> -->
                                            <h3 class="form-title form-title-first"><i class="icon-lock"></i> Error!</h3>
                                            <div class="form-group">
                                                <h4 style="color: red;">Oops something happen at (0xAA)! <br><br>Please contact your system administrator!</h4>
                                            </div>
